...
class MemoryManager:
    ...
    def get_gpu_available_memory(self):
        ...
        return self.gpu_available_memory

    def get_gpu_available_memory_nvidia_smi(self):
        result = subprocess.check_output([
            ...
            encoding='utf-8')
        return int(result.strip().split(',')[0]) * 1024 * 1024

    def get_cpu_available_memory(self):
        self.update_memory_status()
        return self.cpu_available_memory
